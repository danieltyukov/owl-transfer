 ...
 *
 * Same control as the app's, down to the storage key: the visible word is the
 * accessible name and the state is `aria-pressed`, rather than an aria-label
 * that says something the button does not. "System" stays reachable by clearing
 * the stored value, which is what a browser's own site-data control does.
 */
